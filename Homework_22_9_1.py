error = 'Произошла ошибка. Пожалуйста, перезагрузите программу.'
...
if " " not in sequence_numbers:
    print("\nОтсутствуют пробелы! Введите числа, согласно условиям ввода.")
    
if not is_int(sequence_numbers):
    print('\nВы ввели нечисловые значения либо нецелые числа! Введите числа, согласно условиям ввода.\n')
    print(error)
else:
